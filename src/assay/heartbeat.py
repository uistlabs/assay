...
class Heartbeat:
    ...
    def emit(self, stage: str, message: str = "") -> None:
        self._step += 1
        # UTC timestamp so stage durations are readable post-mortem -- "ran ~1 min"
        # was pure inference before this; a load phase that hangs vs crashes looks
        # very different once each line is stamped.
